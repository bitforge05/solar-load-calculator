...
# Add the parent directory to sys.path so we can import from backend.services
sys.path.append(os.path.join(os.path.dirname(__file__), ".."))

from backend.services.extractor import BillExtractor
from backend.services.excel_handler import ExcelHandler

app = FastAPI() # No root_path needed here as Vercel handles /api automatically

# Enable CORS
origins = ["*"] # Simplest for now to ensure it works
app.add_middleware(
    CORSMiddleware,
